...
public class JwtTokenManager {
    ...
    private Key getSignInKey() {
        System.out.println("Secret Key Used for Signing: " + jwtSecret); // Log the secret key
    ...
    private Claims getClaims(String token) {
        try {
            ...
            System.out.println("Could not parse JWT token for claims: " + e.getMessage()); // Log the exception
            return null;
        }
    }
}
